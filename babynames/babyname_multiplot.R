...
# adopted from https://github.com/Pecners/tidytuesday/blob/master/2022/2022-03-22/final_plot.R
...
data <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2022/2022-03-22/babynames.csv')
babes <- data
rm(data)
