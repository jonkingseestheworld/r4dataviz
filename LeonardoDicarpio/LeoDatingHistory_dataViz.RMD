---
title: "Leonardo Dicarpio dating graph"
output: html_notebook
---

Code by Tanya Shapiro
```{r}
...
#plot
leo_lineplot <- ggplot(data=df, aes(x=year)) +
...
finalPlot <- leoNgfs_plot +
  ...
  #plot images
  geom_image(data=images, mapping=aes(y=-14, x=pos, image=here::here('LeonardoDicarpio', path)), size=0.07) +
...
#save plot
ggsave(plot=finalPlot, "plot/dicaprio-gfs.png", height=8, width=8)
